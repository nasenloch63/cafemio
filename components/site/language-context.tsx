...
export const translations = {
  de: {
    ...
    ice: {
      ...
      items: [
        { title: 'Spaghetti-Eis', text: 'Der Klassiker mit Sahne, Schokosauce und einer Waffel voller Herz.', tag: 'Beliebt', price: '6,90 €' },
        { title: 'Frucht-Becher', text: 'Frische Früchte, feines Fruchteis und knusprige Waffeln.', tag: 'Fruchtig', price: '7,50 €' },
        { title: 'Mascarpone-Traum', text: 'Cremige Mascarpone mit frischen Beeren – frisch vor deinen Augen zubereitet.', tag: 'Hausgemacht', price: '7,90 €' },
        { title: 'Frucht-Etagere', text: 'Eine bunte Auswahl an frischen Früchten, liebevoll angerichtet.', tag: 'Zum Teilen', price: '12,90 €' },
      ],
    },
    menu: {
      ...
      categories: [
        ...
        },
        {
          ...
          label: 'Fingerfood',
          items: [
            { name: 'Caprese-Spieße', description: 'Frische Mozzarella-Kugeln, Kirschtomaten und Basilikum auf dem Spieß – beträufelt mit Olivenöl und Balsamico', price: 'auf Anfrage', popular: true, image: '/media/fingerfood.jpg' },
            { name: 'Aufschnittplatte', description: 'Feine Auswahl an Salami, Schinken und Putenwurst, angerichtet mit Gewürzgurken und frischem Brot', price: 'auf Anfrage', image: '/media/teller1.webp' },
            { name: 'Käseplatte', description: 'Verschiedene Sorten Käse mit Trauben, Walnüssen und Honig – perfekt zum Teilen', price: 'auf Anfrage', image: '/media/teller2.webp' },
            { name: 'Gemischte Platte', description: 'Die große Kombinationsplatte mit Aufschnitt, Käse, Caprese-Spießen und knusprigem Brot', price: 'auf Anfrage', popular: true, image: '/media/fruehstueck1.webp' },
          ],
        },
        {
          id: 'kaffee',
          ...
          items: [
            { name: 'Espresso', description: 'Kräftiger Espresso aus unserer hauseignen Mischung', price: '2,20 €' },
            { name: 'Cappuccino', description: 'Espresso mit cremig aufgeschäumter Milch', price: '3,20 €', popular: true },
            { name: 'Caffè Latte', description: 'Milchkaffee mit viel feiner Milch und leichtem Espresso-Aroma', price: '3,50 €' },
            { name: 'Latte Macchiato', description: 'Geschichteter Milchkaffee mit Espresso-Kern', price: '3,80 €' },
            { name: 'Heiße Schokolade', description: 'Cremig und vollmundig – für Momente der Wärme', price: '3,50 €' },
            { name: 'Frisch gepresster Orangensaft', description: 'Täglich frisch gepresst, ohne Zusätze', price: '3,90 €', popular: true },
            { name: 'Mineralwasser (0,3 l)', description: 'Still oder mit Kohlensäure', price: '2,50 €' },
            { name: 'Softdrinks', description: 'Cola, Limo, Apfelschorle – je nach Verfügbarkeit', price: 'ab 2,80 €' },
            { name: 'Prosecco (0,1 l)', description: 'Leichter, perlender Prosecco – perfekt zum Anstoßen', price: '4,50 €' },
          ],
        },
        {
          id: 'kuchen',
          label: 'Kuchen & Süßes',
          items: [
            { name: 'Tagesaktueller Kuchen', description: 'Wechselndes Angebot je nach Saison und Laune unserer Konditorin – fragt gerne nach, was heute frisch gemacht wurde', price: 'ab 3,50 €', popular: true },
            { name: 'Waffel (pur)', description: 'Knusprige Waffel, frisch gebacken – nach Wunsch mit Puderzucker', price: '1,50 €' },
            { name: 'Waffel mit Eis & Sahne', description: 'Frische Waffel, zwei Kugeln Eis nach Wahl und Sahne', price: '5,90 €', popular: true },
            { name: 'Erdbeer-Parfait', description: 'Hausgemachtes Parfait mit frischen Erdbeeren und Sahne', price: '5,50 €' },
            { name: 'Tiramisu', description: 'Klassisches Tiramisu nach Hausrezept – cremig und aromatisch', price: '4,90 €' },
          ],
        },
      ],
    },
  ...
  en: {
    ...
    ice: {
      ...
      items: [
        { title: 'Spaghetti Ice Cream', text: 'The classic with cream, chocolate sauce and a wafer full of heart.', tag: 'Popular', price: '6,90 €' },
        { title: 'Fruit Sundae', text: 'Fresh fruit, delicate fruit gelato and crispy wafers.', tag: 'Fruity', price: '7,50 €' },
        { title: 'Mascarpone Dream', text: 'Creamy mascarpone with fresh berries – prepared fresh before your eyes.', tag: 'Homemade', price: '7,90 €' },
        { title: 'Fruit Étagère', text: 'A colorful selection of fresh fruit, lovingly arranged.', tag: 'To share', price: '12,90 €' },
      ],
    },
    menu: {
      eyebrow: 'La nostra carta',
      ...
      categories: [
        ...
        },
        {
          ...
          label: 'Finger Food',
          items: [
            { name: 'Caprese Skewers', description: 'Fresh mozzarella balls, cherry tomatoes and basil on a skewer – drizzled with olive oil and balsamic glaze', price: 'on request', popular: true, image: '/media/fingerfood.jpg' },
            { name: 'Cold Cut Platter', description: 'Fine selection of salami, ham and turkey sausage, served with gherkins and fresh bread', price: 'on request', image: '/media/teller1.webp' },
            { name: 'Cheese Platter', description: 'Assorted cheeses with grapes, walnuts and honey – perfect for sharing', price: 'on request', image: '/media/teller2.webp' },
            { name: 'Mixed Platter', description: 'The large combination platter with cold cuts, cheese, caprese skewers and crusty bread', price: 'on request', popular: true, image: '/media/fruehstueck1.webp' },
          ],
        },
        {
          id: 'kaffee',
          label: 'Coffee & Drinks',
          items: [
            { name: 'Espresso', description: 'Strong espresso from our house blend', price: '2,20 €' },
            { name: 'Cappuccino', description: 'Espresso with creamy frothed milk', price: '3,20 €', popular: true },
            { name: 'Caffè Latte', description: 'Milky coffee with a light espresso note', price: '3,50 €' },
            { name: 'Latte Macchiato', description: 'Layered milk coffee with an espresso heart', price: '3,80 €' },
            { name: 'Hot Chocolate', description: 'Creamy and full-flavored – for a warm, cozy moment', price: '3,50 €' },
            { name: 'Freshly Squeezed Orange Juice', description: 'Pressed fresh daily, no additives', price: '3,90 €', popular: true },
            { name: 'Mineral Water (0.3 l)', description: 'Still or sparkling', price: '2,50 €' },
            { name: 'Soft Drinks', description: 'Cola, lemonade, apple spritzer – depending on availability', price: 'from 2,80 €' },
            { name: 'Prosecco (0.1 l)', description: 'Light, sparkling prosecco – perfect for a toast', price: '4,50 €' },
          ],
        },
        {
          id: 'kuchen',
          label: 'Cake & Sweets',
          items: [
            { name: 'Daily Cake', description: 'Rotating selection depending on the season and the mood of our baker – ask us what was made fresh today', price: 'from 3,50 €', popular: true },
            { name: 'Waffle (plain)', description: 'Crispy waffle, freshly baked – with icing sugar on request', price: '1,50 €' },
            { name: 'Waffle with Ice Cream & Cream', description: 'Fresh waffle, two scoops of gelato of your choice and cream', price: '5,90 €', popular: true },
            { name: 'Strawberry Parfait', description: 'Homemade parfait with fresh strawberries and cream', price: '5,50 €' },
            { name: 'Tiramisu', description: 'Classic tiramisu from our house recipe – creamy and aromatic', price: '4,90 €' },
          ],
        },
      ],
    },
